        ...
        <section className="mb-8 rounded-xl overflow-hidden">
          <div className="relative h-64 w-full overflow-hidden rounded-xl shadow-lg">
            <img
              ...
              alt="Varanasi - The Eternal City"
              className="h-full w-full object-cover"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent" />
            <div className="absolute left-6 bottom-6 text-white">
              <h2 className="text-3xl font-bold drop-shadow">Varanasi - The Eternal City</h2>
              <p className="mt-1 text-sm">A timeless spiritual landscape along the Ganges</p>
            </div>
          </div>
        </section>
